...
.modal_box {
  ...
  z-index: 1; 
  overflow: auto;
  background: linear-gradient(25deg, rgba(21,50,101,0.95) 0%, rgba(51,73,131,0.7) 40%, rgba(10,90,138,0.8) 100%);
}
